...
export interface ApiDashboardDashboard extends Struct.SingleTypeSchema {
  ...
  attributes: {
    about: Schema.Attribute.Component<'content.about', false> &
    ...
    >;
    premiumServicesTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    package: Schema.Attribute.Relation<'oneToOne', 'api::service.service'>;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    benefitsList: Schema.Attribute.Component<'content.checked-list', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deliveryTimeIcon: Schema.Attribute.Media<
    ...
    inclusionsList: Schema.Attribute.Component<'content.checked-list', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    notesList: Schema.Attribute.Component<'content.checked-list', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    servicePageCta: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
